...
int findElementAtPosition(struct Node* head, int position) {
    if (position < 1) {
        printf("Invalid position.\n");
...
int main() {
    ...
    int positionToFind = 2;
    int foundElement = findElementAtPosition(head, positionToFind);
    if (foundElement != -1) {
        printf("Element at position %d: %d\n", positionToFind, foundElement);
    }
